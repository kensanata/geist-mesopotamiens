...
\marginnote{Herakles ist ein \textit{Sohn des Zeus},
  \textit{jähzornig} und hat \textit{übernatürliche Kraft}. Im Zorn
  hat er schon manchen Unschuldigen erschlagen und gilt deswegen als
  \textit{Mörder}. Er hat sich vor vielen Jahren \textit{für den Pfad
    der Ehre entschieden}.} Diese können zusammen mit
...
\newthought{Jeder Charakter} hat drei Tricks.\marginnote{Herakles hat
  ...
  zu können, wenn es um eine Jagt geht; eine \textit{Ersatzfähigkeit}
