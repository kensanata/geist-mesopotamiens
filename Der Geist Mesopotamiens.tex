...
Gleichstand! Ein temporärer Aspekt ist für den Angreifer enstanden:
Herakles wurde \emph{niedergeworfen}.

\textbf{Zweite Runde}: Herakles greift an und würfelt 0, addiert
Ringen 4, gibt 4. Der Stier würfelt -3, addiert Hörner 4, gibt 1. Da
Herakles \emph{niedergeworfen} ist, addiert der Stier +2, gibt 3. Die
Differenz ist 1 zugunsten von Herakles. Da die Gesundheit des Stiers
schon \(\XBox \Square\) ist, muss trotzdem das zweite Kästchen
genommen werden: \(\XBox \XBox\). Der Stier greift zurück an und
würfelt wieder -1, addiert Hörner 4, gibt 3. Herkules würfelt 0,
